...
public class LrcView extends View implements ILrcView {
    ...
    private int mLrcFontSize = 14;    // font size of lrc
    private int mMinLrcFontSize = 12;
    ...
    public LrcView(Context context, AttributeSet attr) {
        ...
        mLrcFontSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, mLrcFontSize, getResources().getDisplayMetrics());
